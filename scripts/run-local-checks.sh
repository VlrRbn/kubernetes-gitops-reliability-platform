...
"${SCRIPT_DIR}/test-gitops-boundary-guardrails.sh"
"${SCRIPT_DIR}/test-gitops-guardrails.sh"
"${SCRIPT_DIR}/test-promotion-guardrails.sh"
"${SCRIPT_DIR}/test-promotion-diff-guardrails.sh"
...
"${SCRIPT_DIR}/test-admission-policy-guardrails.sh"
"${SCRIPT_DIR}/test-kyverno-audit-reports.sh"
"${SCRIPT_DIR}/test-kyverno-bootstrap-lifecycle.sh"
